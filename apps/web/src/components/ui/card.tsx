...
export const Card=React.forwardRef<HTMLDivElement,React.HTMLAttributes<HTMLDivElement>>(({className,...props},ref)=><div ref={ref} className={cn('rounded-xl border bg-white text-slate-900 shadow-sm',className)} {...props}/>);Card.displayName='Card';
...
export const CardTitle=({className,...props}:React.HTMLAttributes<HTMLHeadingElement>)=><h3 className={cn('text-lg font-semibold leading-none tracking-tight text-[#0b2a4a]',className)} {...props}/>;
