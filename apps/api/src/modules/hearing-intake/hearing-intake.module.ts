...
@Module({ controllers: [HearingIntakeController], providers: [HearingIntakeService, DisabledHearingImportGateway, { provide: HearingImportGateway, useExisting: DisabledHearingImportGateway }], exports: [HearingIntakeService] })
